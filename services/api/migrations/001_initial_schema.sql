...
-- Core domain tables for the agent-workspace MVP.
-- Canonical source: docs/specification/database-schema.md
-- ============================================================
...
CREATE TABLE assets (
    ...
    workspace_id          UUID        NOT NULL REFERENCES workspaces (id),
    project_id            UUID        NOT NULL REFERENCES projects (id),
    uploaded_by_member_id UUID        REFERENCES workspace_members (id),
...
CREATE TABLE agent_credentials (
    ...
    issued_by_member_id UUID        NOT NULL REFERENCES workspace_members (id),
    label               TEXT        NOT NULL,
