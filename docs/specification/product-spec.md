...
| `tasks:write` | Создание, обновление и удаление задач |
| `tasks:write_status` | Ограниченное изменение статуса задач |
| `task_groups:read` | Чтение групп задач |
| `task_groups:write` | Создание, обновление и удаление групп задач |
| `documents:read` | Чтение документов |
| `documents:write` | Создание, обновление, перемещение и удаление документов |
| `assets:read` | Чтение файлов и изображений, связанных с документацией и другими сущностями |
| `assets:write` | Создание, обновление и удаление файлов и изображений |
